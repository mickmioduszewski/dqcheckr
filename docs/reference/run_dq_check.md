...
DuckDB, and renders an HTML report.
...
- snapshot_id:
  ...
  Integer row ID of the snapshot written to DuckDB, or `NULL` if the
  write failed.
...
#> [dqcheckr] starwars_csv: FAIL - 0 warning(s), 2 failure(s). Report: /private/tmp/claude-501/RtmpTXbJKh/starwars_csv_20260601_201408.html
result$status
#> [1] "FAIL"
# }
```
