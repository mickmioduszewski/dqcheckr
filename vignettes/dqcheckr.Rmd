...
| QC-16 | File encoding | Delivery not valid UTF-8 as declared (whole file scanned; run completes via a single-byte fallback and reports the likely actual encoding) | FAIL |
