...
> CP-02 is split into three independent result objects (CP-02a, CP-02b, CP-02c) so each dimension of schema change can be inspected and flag-suppressed separately. The `new_cols_vs_previous`, `missing_cols_vs_previous`, and `type_changed_cols_vs_previous` columns in the `snapshots` table are derived from these results.
